const CATEGORY_DATA = {
    ...
    lolita: {
        ...
        products: [
            ...
            { id: "rose_lace_bonnet", img: "./img/rose-lace-bonnet.png", name: "ローズ・レース・ボンネット", price: "¥3,200" },
            { id: "folklore_cape", img: "./img/scarlet-folklore-cape-set.png", name: "スカーレット・フォークロア・ケープセット", price: "¥8,200" }
        ]
    },
    ouji: {
        title: "OUJI",
