...
const PRODUCT_DB = {
  ...
  "mantle_set": {
    ...
    subImages: ["./img/Cardinal-Youth-Mantle-set.png","./img/Cardinal-Youth-Mantle-set-detail1.png"],
  ...
  "rose_lace_bonnet": {
    ...
    subImages: ["./img/rose-lace-bonnet.png"],
  ...
  "folklore_cape": {
    ...
    subImages: ["./img/scarlet-folklore-cape-set.png"],
